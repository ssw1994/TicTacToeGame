...
export default function App() {
  ...
  const togglePlayerTurn = ()=>{
    updatePlayerTurn(playerTurn === players.player_1 ? players.player_2 : players.player_1)
  }
        ...
        return (
          <div className="row">
            {row.map((value,columnIndex) => {
              return <Box row={rowIndex} column={columnIndex} boxClick={updateGameBoard} text={value}/>;
            })}
          </div>
        );
      })}
